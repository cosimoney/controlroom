    ...
    <div className="min-h-screen" style={{ background: '#020617' }}>
      ...
      <main className="max-w-[1600px] mx-auto px-4 py-4 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-9 gap-3">
          ...
          <KpiCard icon={<AlertTriangle className="h-4 w-4 text-yellow-400" />} label="To Contact"            value={stats.toContact}             color="text-yellow-400"   filterId="to_contact"    active={activeKpiFilter} onToggle={setActiveKpiFilter} />
